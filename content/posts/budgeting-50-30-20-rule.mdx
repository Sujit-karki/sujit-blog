...
faq:
  ...
  - q: "What if my needs exceed 50% of my income?"
    a: "This is common, especially in high cost-of-living cities. If your needs genuinely exceed 50%, focus on reducing housing or transportation costs where possible. If that's not feasible, compress the wants category (30% → 15%) to maintain the 20% savings rate, which is the most important figure."
