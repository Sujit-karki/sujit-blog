...
<InfoBox type="info" title="The follow-up: hand them the source">
The next day I gave the same four models Apple's press release and the
pre-event rumours, together and apart. They read the right price out of the
release 60 times out of 60 and never took a rumour's side, but asked whether
each rumour was true, they called every claim false, including the two that
were right. [Read the 420-answer rumour check](/posts/local-ai-rumour-check-2026).
</InfoBox>
