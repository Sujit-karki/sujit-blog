  ...
  return (
    <div className="not-prose my-8 p-5 sm:p-6 bg-gray-50 dark:bg-gray-900/60 border border-gray-200 dark:border-gray-700 rounded-2xl">
      ...
      <div className="space-y-5 mb-6">
        ...
        <div>
          <p className="font-mono text-[11px] uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">Grade level mix</p>
        ...
        <div>
          ...
          <input
            ...
            className="w-full accent-emerald-600"
          />
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Illustrative ±15–20% band, not a specific state or metro figure.</p>
        </div>
      </div>

      <div className="pt-5 border-t border-dashed border-gray-200 dark:border-gray-700">
        <p className="font-serif text-lg sm:text-xl leading-snug mb-4 text-gray-900 dark:text-white">
          Estimated total: <strong className="text-emerald-700 dark:text-emerald-400">{money(total)}</strong>
          {' '}for {kids} {kids === 1 ? 'kid' : 'kids'} this back-to-school season.
        </p>

        <div className="grid sm:grid-cols-2 gap-4 mb-5">
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            <p className="font-mono text-[11px] uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-1">Your estimated total</p>
            <AnimatedNumber
              value={total}
              format={money}
              startFromZero
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            <p className="font-mono text-[11px] uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-1">Per kid</p>
            <AnimatedNumber
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">Estimate only — not financial advice.</p>
