    ...
    <div className="not-prose my-8 p-5 sm:p-6 bg-gray-50 dark:bg-gray-900/60 border border-gray-200 dark:border-gray-700 rounded-2xl">
      ...
      <div className="pt-5 border-t border-dashed border-gray-200 dark:border-gray-700">
        <p className="font-serif text-lg sm:text-xl leading-snug mb-4 text-gray-900 dark:text-white">
          ...
          <strong className="text-emerald-600 dark:text-emerald-400">{cents(totalCostPerMile * 100)}/mile</strong> to
          drive — roughly <strong>{money(monthlyCost)}/month</strong>.
        </p>

        <div className="grid sm:grid-cols-3 gap-4">
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            <p className="font-mono text-[11px] uppercase tracking-widest text-gray-400 mb-1">Cost per mile</p>
            <p className="font-serif text-2xl font-bold text-gray-900 dark:text-white">{cents(totalCostPerMile * 100)}</p>
          </div>
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            <p className="font-mono text-[11px] uppercase tracking-widest text-gray-400 mb-1">Monthly cost</p>
            <AnimatedNumber
              value={monthlyCost}
              format={v => money(v)}
              startFromZero
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            <p className="font-mono text-[11px] uppercase tracking-widest text-gray-400 mb-1">Annual cost</p>
            <AnimatedNumber
              value={annualCost}
              format={v => money(v)}
              startFromZero
