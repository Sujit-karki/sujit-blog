      ...
      <div className="pt-5 border-t border-dashed border-gray-200 dark:border-gray-700">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            <p className="font-mono text-[11px] uppercase tracking-widest text-gray-400 mb-1">Annual income gap</p>
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            <p className="font-mono text-[11px] uppercase tracking-widest text-gray-400 mb-1">Monthly gross side income needed</p>
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            <p className="font-mono text-[11px] uppercase tracking-widest text-gray-400 mb-1">Tax reserve applied</p>
        ...
        <p className="text-xs text-gray-400 mt-4">Estimate only — not financial advice.</p>
