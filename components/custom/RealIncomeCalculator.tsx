    ...
    <ChartCard>
      ...
      <div className="grid grid-cols-2 gap-px bg-gray-200 dark:bg-gray-700 rounded-xl overflow-hidden">
        <div className="bg-white dark:bg-gray-900 p-4 text-center">
          <p className="font-mono text-[10px] uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1">New nominal income</p>
          <AnimatedNumber
        ...
        <div className="bg-white dark:bg-gray-900 p-4 text-center">
          <p className="font-mono text-[10px] uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1">New real (inflation-adjusted) income</p>
          <AnimatedNumber
        ...
        <div className="bg-white dark:bg-gray-900 p-4 text-center">
          <p className="font-mono text-[10px] uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1">Real change in purchasing power</p>
          <AnimatedNumber
            value={result.realChangePct}
            format={pct}
            startFromZero
            className={`font-serif text-xl sm:text-2xl font-bold block ${
              losingGround ? 'text-red-600 dark:text-red-400' : 'text-emerald-700 dark:text-emerald-400'
            }`}
          />
        </div>
        <div className="bg-white dark:bg-gray-900 p-4 text-center">
          <p className="font-mono text-[10px] uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1">Break-even raise needed</p>
